\documentclass[11pt,a4paper,twocols,margin=1.20cm]{avaliacao}
...
\turno{Diurno}
\professor{Bernhard Georg Enders}
\header
...
\begin{instrucoes}%
  ...
  \item Poste suas respostas em \href{https://gabarito.sistema.pro.br}
\end{instrucoes}
...
\begin{subitens}
    \item Determine, em \textbf{m/min}, o módulo da velocidade média nos primeiros dois minutos.
    \item Determine, em \textbf{m/min}, o módulo da velocidade instantânea em $t=2$~min.
    \item Determine, em segundos, o instante em que a aceleração da partícula é nula.
\end{subitens}
\end{questao}
\end{document}
